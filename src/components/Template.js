	...
	return (
	  <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
        <div className='w-11/12 max-w-[450px]'>
            <h1
            className='text-rickblack-5 font-semibold text-[1.875rem] leading-[2.375rem]'
            >{title}</h1>
            ...
            <button style={{ fontSize: '1.5rem' }}
             className='flex w-full justify-center items-center rounded-[8px] font-medium text-richblack-100 border
